...
{images?.map((img,idx)=> 
<img  key= {idx} className={`md:w-20 md:h-20 w-10 h-10 cursor-pointer rounded overflow-x-auto border-red-400 border-${index===idx ? '2' : '0'} object-fill `} src={img} alt='' onClick={()=> updateIndex(idx)}/> 
